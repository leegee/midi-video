...
describe('Encoder', () => {
    ...
    it('create video', () => {
        ...
        p.then((encoderExitStatus) => {
            expect(encoder.totalImagesAdded).to.equal(totalImagesAdded);
